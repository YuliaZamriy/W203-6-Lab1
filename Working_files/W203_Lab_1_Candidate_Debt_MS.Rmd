...
par(mar=c(4,15,4,5))
y = barplot(sort(table(CandidateDebtSub$office)), 
            horiz=TRUE, 
            las = 1, 
            cex.names = 0.5,
            col='coral1', 
            main = 'Number of Debt Filings by Political Office of Candidate',
            border=NA)
...
```
### YZ: Maybe for the below we need table only

```{r}
table(CandidateDebtSub$vendorcity)
# par(mar=c(2.5,7,4,4))
# barplot(sort(table(CandidateDebtSub$vendorcity)), 
#         horiz = TRUE,
#         las = 2, 
#         cex.names=0.6, 
#         main = 'Number of Debt Filings by City of Debt Holder', 
#         xlab = 'State', 
#         col='coral1', 
#         border=NA)
```
...
### YZ: We should fit the following two charts next to each other
...
barplot(sort(table(CandidateDebtSub$description_aggr)), 
        ...
        las = 2, 
        cex.names=0.8, 
        main = 'Number of Debt Filings by Debt Description (Derived)', 
        xlab = 'Number of Debt Filings', 
        col='coral1', 
        border=NA)
```
...
barplot(aggr_descr$amount_num, 
        ...
        las = 2, 
        cex.names=0.8, 
        main = 'Total Debt Amount By Debt Description (Derived)', 
        xlab = "Debt Amount ($ '000)", 
        axes = FALSE,
        col='coral1', 
        border=NA)
...
barplot(sort(vendorTable[1:15]), 
        ...
        las = 2, 
        cex.names=0.8, 
        main = 'Number of Debt Filings by Vendor', 
        xlab = 'Number of Debt Filings', 
        col='coral1', 
        border=NA)
```

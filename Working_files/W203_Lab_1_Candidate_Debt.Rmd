...
While we were able to identify these simple, high level observations, our analysis was significantly constrained by the some inconsistencies and shortcomings in the data. In order to improve our analysis in the future, we recommend the following improved practices:
